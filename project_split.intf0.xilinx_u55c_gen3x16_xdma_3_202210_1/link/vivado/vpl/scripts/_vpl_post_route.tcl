...
write_cookie_file_impl "vnx_project_split_if0"

# utilization reports
report_utilization_impl true "cmac_0 networklayer krnl_proj_split" "routed" "level0_i/ulp" $input_dir $vivado_output_dir
