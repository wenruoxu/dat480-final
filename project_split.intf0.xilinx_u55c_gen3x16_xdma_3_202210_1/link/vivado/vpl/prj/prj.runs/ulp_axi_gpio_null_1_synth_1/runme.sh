...
HD_PWD='/home/m2_2/shared/dat480-final/project_split.intf0.xilinx_u55c_gen3x16_xdma_3_202210_1/link/vivado/vpl/prj/prj.runs/ulp_axi_gpio_null_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ulp_axi_gpio_null_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ulp_axi_gpio_null_1.tcl
