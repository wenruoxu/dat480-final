...
(* CORE_GENERATION_INFO="ethernet_header_inserter_ethernet_header_inserter,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=2.800000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.543431,HLS_SYN_LAT=8,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=14368,HLS_SYN_LUT=7304,HLS_VERSION=2023_2}" *)
...
wire   [4:0] ip_header_out_num_data_valid;
wire   [4:0] ip_header_out_fifo_cap;
wire    ip_header_out_empty_n;
wire    no_ip_header_out_full_n;
wire   [1023:0] no_ip_header_out_dout;
wire   [4:0] no_ip_header_out_num_data_valid;
wire   [4:0] no_ip_header_out_fifo_cap;
wire    no_ip_header_out_empty_n;
wire    ip_header_checksum_full_n;
wire   [1023:0] ip_header_checksum_dout;
wire   [4:0] ip_header_checksum_num_data_valid;
wire   [4:0] ip_header_checksum_fifo_cap;
...
ethernet_header_inserter_broadcaster_and_mac_request broadcaster_and_mac_request_U0(
    ...
    .ip_header_out_num_data_valid(ip_header_out_num_data_valid),
    .ip_header_out_fifo_cap(ip_header_out_fifo_cap),
    ...
    .no_ip_header_out_num_data_valid(no_ip_header_out_num_data_valid),
    .no_ip_header_out_fifo_cap(no_ip_header_out_fifo_cap),
...
ethernet_header_inserter_compute_and_insert_ip_checksum compute_and_insert_ip_checksum_U0(
    ...
    .ip_header_checksum_num_data_valid(ip_header_checksum_num_data_valid),
    .ip_header_checksum_fifo_cap(ip_header_checksum_fifo_cap),
...
ethernet_header_inserter_fifo_w1024_d16_A ip_header_out_U(
    ...
    .if_num_data_valid(ip_header_out_num_data_valid),
    .if_fifo_cap(ip_header_out_fifo_cap),
...
ethernet_header_inserter_fifo_w1024_d16_A no_ip_header_out_U(
    ...
    .if_num_data_valid(no_ip_header_out_num_data_valid),
    .if_fifo_cap(no_ip_header_out_fifo_cap),
...
ethernet_header_inserter_fifo_w1024_d16_A ip_header_checksum_U(
    ...
    .if_num_data_valid(ip_header_checksum_num_data_valid),
    .if_fifo_cap(ip_header_checksum_fifo_cap),
