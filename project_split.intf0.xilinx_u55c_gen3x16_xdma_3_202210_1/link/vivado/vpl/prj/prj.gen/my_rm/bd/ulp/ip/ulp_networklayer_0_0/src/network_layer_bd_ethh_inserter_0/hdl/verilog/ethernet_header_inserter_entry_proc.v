...
module ethernet_header_inserter_entry_proc (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (myMacAddress_c_full_n == 1'b0) | (ap_done_reg == 1'b1));
end
...
endmodule //ethernet_header_inserter_entry_proc
