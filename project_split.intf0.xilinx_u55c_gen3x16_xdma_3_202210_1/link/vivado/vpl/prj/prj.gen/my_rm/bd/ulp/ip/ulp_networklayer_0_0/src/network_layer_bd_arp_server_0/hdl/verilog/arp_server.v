...
(* CORE_GENERATION_INFO="arp_server_arp_server,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=2.800000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.792859,HLS_SYN_LAT=5,HLS_SYN_TPT=3,HLS_SYN_MEM=3,HLS_SYN_DSP=0,HLS_SYN_FF=1825,HLS_SYN_LUT=1949,HLS_VERSION=2023_2}" *)
...
wire   [2:0] myIpAddress_c11_num_data_valid;
wire   [2:0] myIpAddress_c11_fifo_cap;
