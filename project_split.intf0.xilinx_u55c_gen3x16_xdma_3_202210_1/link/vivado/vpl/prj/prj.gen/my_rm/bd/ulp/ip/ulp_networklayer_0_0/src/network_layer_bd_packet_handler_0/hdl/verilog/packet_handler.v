...
(* CORE_GENERATION_INFO="packet_handler_packet_handler,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=2.800000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=4.959585,HLS_SYN_LAT=4,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=6561,HLS_SYN_LUT=2651,HLS_VERSION=2023_2}" *)
