...
//--------------------------------------------------------------------------------
//Command: generate_target bd_7cf0.bd
//Design : bd_7cf0
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_7cf0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_7cf0,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "bd_097b_user_debug_bridge_0.hwdef" *) 
module bd_7cf0
   (S_AXI_araddr,
    S_AXI_arprot,
    S_AXI_arready,
  ...
  bd_7cf0_axi_jtag_0 axi_jtag
       (.s_axi_aclk(s_axi_aclk_1),
        ...
        .tdo(bsip_tap_tdo),
        .tms(axi_jtag_tms));
  bd_7cf0_bs_switch_1_0 bs_switch_1
