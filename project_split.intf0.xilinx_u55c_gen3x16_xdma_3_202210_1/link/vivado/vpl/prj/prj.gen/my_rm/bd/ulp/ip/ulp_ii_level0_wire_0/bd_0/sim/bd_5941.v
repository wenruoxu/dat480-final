...
module bd_5941
  ...
  wire [1:0]m_ip_axi_data_c2h_00_M_AXI_ARID;
  ...
  wire [1:0]m_ip_axi_data_c2h_00_M_AXI_RID;
  ...
  assign BLP_M_AXI_DATA_C2H_00_araddr[38:0] = m_ip_axi_data_c2h_00_M_AXI_ARADDR;
  assign BLP_M_AXI_DATA_C2H_00_arburst[1:0] = m_ip_axi_data_c2h_00_M_AXI_ARBURST;
  assign BLP_M_AXI_DATA_C2H_00_arid[1:0] = m_ip_axi_data_c2h_00_M_AXI_ARID;
  assign BLP_M_AXI_DATA_C2H_00_arlen[7:0] = m_ip_axi_data_c2h_00_M_AXI_ARLEN;
  assign BLP_M_AXI_DATA_C2H_00_arvalid = m_ip_axi_data_c2h_00_M_AXI_ARVALID;
  assign BLP_M_AXI_DATA_C2H_00_awaddr[38:0] = m_ip_axi_data_c2h_00_M_AXI_AWADDR;
  assign BLP_M_AXI_DATA_C2H_00_awburst[1:0] = m_ip_axi_data_c2h_00_M_AXI_AWBURST;
  assign BLP_M_AXI_DATA_C2H_00_awid[1:0] = m_ip_axi_data_c2h_00_M_AXI_AWID;
  assign BLP_M_AXI_DATA_C2H_00_awlen[7:0] = m_ip_axi_data_c2h_00_M_AXI_AWLEN;
  assign BLP_M_AXI_DATA_C2H_00_awvalid = m_ip_axi_data_c2h_00_M_AXI_AWVALID;
  assign BLP_M_AXI_DATA_C2H_00_bready = m_ip_axi_data_c2h_00_M_AXI_BREADY;
  assign BLP_M_AXI_DATA_C2H_00_rready = m_ip_axi_data_c2h_00_M_AXI_RREADY;
  assign BLP_M_AXI_DATA_C2H_00_wdata[511:0] = m_ip_axi_data_c2h_00_M_AXI_WDATA;
  assign BLP_M_AXI_DATA_C2H_00_wlast = m_ip_axi_data_c2h_00_M_AXI_WLAST;
  assign BLP_M_AXI_DATA_C2H_00_wstrb[63:0] = m_ip_axi_data_c2h_00_M_AXI_WSTRB;
  assign BLP_M_AXI_DATA_C2H_00_wvalid = m_ip_axi_data_c2h_00_M_AXI_WVALID;
  ...
  assign m_ip_axi_data_c2h_00_M_AXI_ARREADY = BLP_M_AXI_DATA_C2H_00_arready;
  assign m_ip_axi_data_c2h_00_M_AXI_AWREADY = BLP_M_AXI_DATA_C2H_00_awready;
  assign m_ip_axi_data_c2h_00_M_AXI_BID = BLP_M_AXI_DATA_C2H_00_bid[1:0];
  assign m_ip_axi_data_c2h_00_M_AXI_BRESP = BLP_M_AXI_DATA_C2H_00_bresp[1:0];
  assign m_ip_axi_data_c2h_00_M_AXI_BVALID = BLP_M_AXI_DATA_C2H_00_bvalid;
  assign m_ip_axi_data_c2h_00_M_AXI_RDATA = BLP_M_AXI_DATA_C2H_00_rdata[511:0];
  assign m_ip_axi_data_c2h_00_M_AXI_RID = BLP_M_AXI_DATA_C2H_00_rid[1:0];
  assign m_ip_axi_data_c2h_00_M_AXI_RLAST = BLP_M_AXI_DATA_C2H_00_rlast;
  assign m_ip_axi_data_c2h_00_M_AXI_RRESP = BLP_M_AXI_DATA_C2H_00_rresp[1:0];
  assign m_ip_axi_data_c2h_00_M_AXI_RVALID = BLP_M_AXI_DATA_C2H_00_rvalid;
  assign m_ip_axi_data_c2h_00_M_AXI_WREADY = BLP_M_AXI_DATA_C2H_00_wready;
  ...
  bd_5941_m_ip_axi_ctrl_user_03_0 m_ip_axi_ctrl_user_03
       (.aclk(ip_aclk_ctrl_00_clk_out),
        .aresetn(ip_aresetn_ctrl_00_q),
  ...
  bd_5941_m_ip_axi_data_c2h_00_0 m_ip_axi_data_c2h_00
  ...
  bd_5941_s_ip_axi_ctrl_user_03_0 s_ip_axi_ctrl_user_03
       (.aclk(blp_s_aclk_ctrl_00_1),
        .aresetn(blp_s_aresetn_ctrl_00_1),
        ...
        .s_axi_araddr(BLP_S_AXI_CTRL_USER_03_1_ARADDR),
        .s_axi_arprot(BLP_S_AXI_CTRL_USER_03_1_ARPROT),
        .s_axi_arready(BLP_S_AXI_CTRL_USER_03_1_ARREADY),
        .s_axi_arvalid(BLP_S_AXI_CTRL_USER_03_1_ARVALID),
        .s_axi_awaddr(BLP_S_AXI_CTRL_USER_03_1_AWADDR),
        .s_axi_awprot(BLP_S_AXI_CTRL_USER_03_1_AWPROT),
        .s_axi_awready(BLP_S_AXI_CTRL_USER_03_1_AWREADY),
        .s_axi_awvalid(BLP_S_AXI_CTRL_USER_03_1_AWVALID),
        .s_axi_bready(BLP_S_AXI_CTRL_USER_03_1_BREADY),
        .s_axi_bresp(BLP_S_AXI_CTRL_USER_03_1_BRESP),
        .s_axi_bvalid(BLP_S_AXI_CTRL_USER_03_1_BVALID),
        .s_axi_rdata(BLP_S_AXI_CTRL_USER_03_1_RDATA),
        .s_axi_rready(BLP_S_AXI_CTRL_USER_03_1_RREADY),
        .s_axi_rresp(BLP_S_AXI_CTRL_USER_03_1_RRESP),
        .s_axi_rvalid(BLP_S_AXI_CTRL_USER_03_1_RVALID),
        .s_axi_wdata(BLP_S_AXI_CTRL_USER_03_1_WDATA),
        .s_axi_wready(BLP_S_AXI_CTRL_USER_03_1_WREADY),
        .s_axi_wstrb(BLP_S_AXI_CTRL_USER_03_1_WSTRB),
        .s_axi_wvalid(BLP_S_AXI_CTRL_USER_03_1_WVALID));
  bd_5941_s_ip_axi_data_c2h_00_0 s_ip_axi_data_c2h_00
       (.aclk(ip_aclk_pcie_00_clk_out),
        .aresetn(ip_aresetn_pcie_00_q),
