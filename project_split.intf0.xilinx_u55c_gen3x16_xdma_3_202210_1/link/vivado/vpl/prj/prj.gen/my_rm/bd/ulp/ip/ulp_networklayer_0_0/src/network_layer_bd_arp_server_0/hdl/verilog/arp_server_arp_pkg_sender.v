...
wire   [0:0] tmp_8_i_nbreadreq_fu_182_p3;
reg    ap_predicate_op31_read_state1;
reg    ap_predicate_op36_read_state1;
reg    ap_done_reg;
reg    ap_block_state1_pp0_stage0_iter0;
reg   [1:0] aps_fsmState_load_reg_515;
reg    ap_block_state2_pp0_stage0_iter1;
reg    ap_block_state2_io;
wire    ap_CS_iter1_fsm_state2;
reg   [1:0] aps_fsmState_load_reg_515_pp0_iter1_reg;
...
reg   [31:0] networkMask_read_reg_490;
reg   [31:0] auxQueryIP_1_reg_495;
reg   [31:0] myIpAddress_read_reg_500;
reg   [47:0] myMacAddress_read_reg_507;
wire   [511:0] zext_ln117_1_fu_421_p1;
wire   [511:0] zext_ln117_fu_485_p1;
wire   [47:0] trunc_ln122_fu_249_p1;
wire   [31:0] xor_ln136_fu_381_p2;
wire   [31:0] and_ln136_fu_386_p2;
wire   [0:0] icmp_ln136_fu_391_p2;
wire   [31:0] auxQueryIP_2_fu_397_p3;
wire   [430:0] sendWord_data_1_fu_404_p9;
wire   [430:0] sendWord_data_fu_458_p14;
...
wire   [63:0] arpDataOut_TSTRB_int_regslice;
...
always @ (posedge ap_clk) begin
    if ((~(aps_fsmState == 2'd2) & ~(aps_fsmState == 2'd1) & ~((1'b1 == ap_block_state1_pp0_stage0_iter0) | (ap_done_reg == 1'b1) | ((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | (1'b1 == ap_block_state3_pp0_stage0_iter2))) | ((1'b1 == ap_CS_iter1_fsm_state2) & ((1'b1 == ap_block_state2_io) | (1'b1 == ap_block_state2_pp0_stage0_iter1)))) & (tmp_i_nbreadreq_fu_174_p3 == 1'd1) & (1'b1 == ap_CS_iter0_fsm_state1))) begin
        aps_fsmState <= 2'd1;
    end else if ((~(aps_fsmState == 2'd2) & ~(aps_fsmState == 2'd1) & ~((1'b1 == ap_block_state1_pp0_stage0_iter0) | (ap_done_reg == 1'b1) | ((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | (1'b1 == ap_block_state3_pp0_stage0_iter2))) | ((1'b1 == ap_CS_iter1_fsm_state2) & ((1'b1 == ap_block_state2_io) | (1'b1 == ap_block_state2_pp0_stage0_iter1)))) & (tmp_8_i_nbreadreq_fu_182_p3 == 1'd1) & (tmp_i_nbreadreq_fu_174_p3 == 1'd0) & (1'b1 == ap_CS_iter0_fsm_state1))) begin
        aps_fsmState <= 2'd2;
...
always @ (posedge ap_clk) begin
    if ((~((1'b1 == ap_block_state1_pp0_stage0_iter0) | (ap_done_reg == 1'b1) | ((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | (1'b1 == ap_block_state3_pp0_stage0_iter2))) | ((1'b1 == ap_CS_iter1_fsm_state2) & ((1'b1 == ap_block_state2_io) | (1'b1 == ap_block_state2_pp0_stage0_iter1)))) & (1'b1 == ap_CS_iter0_fsm_state1))) begin
        aps_fsmState_load_reg_515 <= aps_fsmState;
        auxQueryIP_1_reg_495 <= gatewayIP_dout;
        myIpAddress_read_reg_500 <= myIpAddress_dout;
        myMacAddress_read_reg_507 <= myMacAddress_dout;
        networkMask_read_reg_490 <= networkMask_dout;
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((1'b1 == ap_block_state2_io) | (1'b1 == ap_block_state2_pp0_stage0_iter1) | (ap_done_reg == 1'b1) | ((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | (1'b1 == ap_block_state3_pp0_stage0_iter2)))) & (1'b1 == ap_CS_iter1_fsm_state2))) begin
        aps_fsmState_load_reg_515_pp0_iter1_reg <= aps_fsmState_load_reg_515;
    end
end
...
always @ (*) begin
    if ((((1'b1 == ap_CS_iter2_fsm_state3) & (aps_fsmState_load_reg_515_pp0_iter1_reg == 2'd1)) | ((1'b1 == ap_CS_iter2_fsm_state3) & (aps_fsmState_load_reg_515_pp0_iter1_reg == 2'd2)) | ((1'b1 == ap_CS_iter1_fsm_state2) & (aps_fsmState_load_reg_515 == 2'd1)) | ((1'b1 == ap_CS_iter1_fsm_state2) & (aps_fsmState_load_reg_515 == 2'd2)))) begin
...
always @ (*) begin
    if ((1'b1 == ap_condition_273)) begin
        if ((aps_fsmState_load_reg_515 == 2'd1)) begin
            arpDataOut_TDATA_int_regslice = zext_ln117_fu_485_p1;
        end else if ((aps_fsmState_load_reg_515 == 2'd2)) begin
            arpDataOut_TDATA_int_regslice = zext_ln117_1_fu_421_p1;
        end else begin
...
always @ (*) begin
    if (((~((1'b1 == ap_block_state2_io) | (1'b1 == ap_block_state2_pp0_stage0_iter1) | (ap_done_reg == 1'b1) | ((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | (1'b1 == ap_block_state3_pp0_stage0_iter2)))) & (1'b1 == ap_CS_iter1_fsm_state2) & (aps_fsmState_load_reg_515 == 2'd1)) | (~((1'b1 == ap_block_state2_io) | (1'b1 == ap_block_state2_pp0_stage0_iter1) | (ap_done_reg == 1'b1) | ((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | (1'b1 == ap_block_state3_pp0_stage0_iter2)))) & (1'b1 == ap_CS_iter1_fsm_state2) & (aps_fsmState_load_reg_515 == 2'd2)))) begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_iter0_fsm_state1) & (ap_start == 1'b1) & (ap_predicate_op36_read_state1 == 1'b1))) begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (ap_predicate_op31_read_state1 == 1'b1) & (1'b1 == ap_CS_iter0_fsm_state1) & (ap_start == 1'b1))) begin
...
always @ (*) begin
    if ((~((1'b1 == ap_block_state1_pp0_stage0_iter0) | (ap_done_reg == 1'b1) | ((1'b1 == ap_CS_iter2_fsm_state3) & ((1'b1 == ap_block_state3_io) | (1'b1 == ap_block_state3_pp0_stage0_iter2))) | ((1'b1 == ap_CS_iter1_fsm_state2) & ((1'b1 == ap_block_state2_io) | (1'b1 == ap_block_state2_pp0_stage0_iter1)))) & (ap_predicate_op31_read_state1 == 1'b1) & (1'b1 == ap_CS_iter0_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_iter0_fsm_state1) & (ap_start == 1'b1))) begin
...
assign and_ln136_fu_386_p2 = (xor_ln136_fu_381_p2 & networkMask_read_reg_490);
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((myMacAddress_empty_n == 1'b0) | (myIpAddress_empty_n == 1'b0) | (gatewayIP_empty_n == 1'b0) | (networkMask_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1) | ((ap_predicate_op31_read_state1 == 1'b1) & (arpRequestFifo_empty_n == 1'b0)) | ((ap_predicate_op36_read_state1 == 1'b1) & (arpReplyFifo_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_state2_io = (((arpDataOut_TREADY_int_regslice == 1'b0) & (aps_fsmState_load_reg_515 == 2'd1)) | ((arpDataOut_TREADY_int_regslice == 1'b0) & (aps_fsmState_load_reg_515 == 2'd2)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (((arpDataOut_TREADY_int_regslice == 1'b0) & (aps_fsmState_load_reg_515 == 2'd1)) | ((arpDataOut_TREADY_int_regslice == 1'b0) & (aps_fsmState_load_reg_515 == 2'd2)));
end

always @ (*) begin
    ap_block_state3_io = (((arpDataOut_TREADY_int_regslice == 1'b0) & (aps_fsmState_load_reg_515_pp0_iter1_reg == 2'd1)) | ((arpDataOut_TREADY_int_regslice == 1'b0) & (aps_fsmState_load_reg_515_pp0_iter1_reg == 2'd2)));
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((regslice_both_arpDataOut_V_data_V_U_apdone_blk == 1'b1) | ((arpDataOut_TREADY_int_regslice == 1'b0) & (aps_fsmState_load_reg_515_pp0_iter1_reg == 2'd1)) | ((arpDataOut_TREADY_int_regslice == 1'b0) & (aps_fsmState_load_reg_515_pp0_iter1_reg == 2'd2)));
end

always @ (*) begin
    ap_condition_273 = (~((1'b1 == ap_block_state2_pp0_stage0_iter1) | (ap_done_reg == 1'b1) | ((1'b1 == ap_CS_iter2_fsm_state3) & (1'b1 == ap_block_state3_pp0_stage0_iter2))) & (1'b1 == ap_CS_iter1_fsm_state2));
end

always @ (*) begin
    ap_predicate_op31_read_state1 = (~(aps_fsmState == 2'd2) & ~(aps_fsmState == 2'd1) & (tmp_8_i_nbreadreq_fu_182_p3 == 1'd1) & (tmp_i_nbreadreq_fu_174_p3 == 1'd0));
end

always @ (*) begin
    ap_predicate_op36_read_state1 = (~(aps_fsmState == 2'd2) & ~(aps_fsmState == 2'd1) & (tmp_i_nbreadreq_fu_174_p3 == 1'd1));
end
...
assign auxQueryIP_2_fu_397_p3 = ((icmp_ln136_fu_391_p2[0:0] == 1'b1) ? inputIP : auxQueryIP_1_reg_495);

assign icmp_ln136_fu_391_p2 = ((and_ln136_fu_386_p2 == 32'd0) ? 1'b1 : 1'b0);

assign sendWord_data_1_fu_404_p9 = {{{{{{{{{{{{{{95'd21438213421863513942334111744}, {auxQueryIP_2_fu_397_p3}}}, {48'd0}}}, {myIpAddress_read_reg_500}}}, {myMacAddress_read_reg_507}}}, {80'd4722656402130033706504}}}, {myMacAddress_read_reg_507}}}, {48'd281474976710655}};

assign sendWord_data_fu_458_p14 = {{{{{{{{{{{{{{{{{{{{{{{{95'd21438213421863513942334111744}, {replyMeta_protoAddrSrc}}}, {replyMeta_hwAddrSrc}}}, {myIpAddress_read_reg_500}}}, {myMacAddress_read_reg_507}}}, {16'd512}}}, {replyMeta_protoLen}}}, {replyMeta_hwLen}}}, {replyMeta_protoType}}}, {replyMeta_hwType}}}, {replyMeta_ethType}}}, {myMacAddress_read_reg_507}}}, {replyMeta_srcMac}};

assign tmp_8_i_nbreadreq_fu_182_p3 = arpRequestFifo_empty_n;

assign tmp_i_nbreadreq_fu_174_p3 = arpReplyFifo_empty_n;

assign trunc_ln122_fu_249_p1 = arpReplyFifo_dout[47:0];

assign xor_ln136_fu_381_p2 = (myIpAddress_read_reg_500 ^ inputIP);

assign zext_ln117_1_fu_421_p1 = sendWord_data_1_fu_404_p9;

assign zext_ln117_fu_485_p1 = sendWord_data_fu_458_p14;
