...
wire   [511:0] tmp_57_i2_fu_418_p5;
wire   [511:0] zext_ln133_fu_496_p1;
wire   [63:0] tmp_59_i4_fu_436_p5;
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (1'b1 == ap_block_state1_pp0_stage0_iter0) | ((1'b1 == ap_CS_iter1_fsm_state2) & (1'b1 == ap_block_state2_pp0_stage0_iter1))) & (grp_nbreadreq_fu_142_p6 == 1'd1) & (ure_state == 2'd1) & (1'b1 == ap_CS_iter0_fsm_state1) & (tmp_fu_250_p3 == 1'd0) & (grp_fu_206_p1 == 1'd1))) begin
        ap_phi_reg_pp0_iter1_sendWord_last_reg_182 <= 1'd1;
    end else if (((~((ap_done_reg == 1'b1) | (1'b1 == ap_block_state1_pp0_stage0_iter0) | ((1'b1 == ap_CS_iter1_fsm_state2) & (1'b1 == ap_block_state2_pp0_stage0_iter1))) & (grp_nbreadreq_fu_142_p6 == 1'd1) & (ure_state == 2'd1) & (1'b1 == ap_CS_iter0_fsm_state1) & (grp_fu_206_p1 == 1'd0)) | (~((ap_done_reg == 1'b1) | (1'b1 == ap_block_state1_pp0_stage0_iter0) | ((1'b1 == ap_CS_iter1_fsm_state2) & (1'b1 == ap_block_state2_pp0_stage0_iter1))) & (grp_nbreadreq_fu_142_p6 == 1'd1) & (ure_state == 2'd1) & (1'b1 == ap_CS_iter0_fsm_state1) & (tmp_fu_250_p3 == 1'd1) & (grp_fu_206_p1 == 1'd1)))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_244)) begin
        if ((1'b1 == ap_condition_99)) begin
            ...
            prevWord_data_1 <= tmp_57_i2_fu_418_p5;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_244)) begin
        if ((1'b1 == ap_condition_99)) begin
            ...
            prevWord_keep_1 <= tmp_59_i4_fu_436_p5;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((~(ure_state == 2'd2) & ~(ure_state == 2'd1) & ~((ap_done_reg == 1'b1) | (1'b1 == ap_block_state1_pp0_stage0_iter0) | ((1'b1 == ap_CS_iter1_fsm_state2) & (1'b1 == ap_block_state2_pp0_stage0_iter1))) & (grp_nbreadreq_fu_142_p6 == 1'd1) & (1'b1 == ap_CS_iter0_fsm_state1)) | (~((ap_done_reg == 1'b1) | (1'b1 == ap_block_state1_pp0_stage0_iter0) | ((1'b1 == ap_CS_iter1_fsm_state2) & (1'b1 == ap_block_state2_pp0_stage0_iter1))) & (grp_nbreadreq_fu_142_p6 == 1'd1) & (ure_state == 2'd1) & (1'b1 == ap_CS_iter0_fsm_state1)))) begin
...
always @ (*) begin
    if (((~((ap_done_reg == 1'b1) | (real_start == 1'b0)) & (ap_predicate_op26_read_state1 == 1'b1) & (1'b1 == ap_CS_iter0_fsm_state1) & (real_start == 1'b1)) | (~((ap_done_reg == 1'b1) | (real_start == 1'b0)) & (ap_predicate_op7_read_state1 == 1'b1) & (1'b1 == ap_CS_iter0_fsm_state1) & (real_start == 1'b1)))) begin
...
always @ (*) begin
    if (((~((ap_done_reg == 1'b1) | (1'b1 == ap_block_state1_pp0_stage0_iter0) | ((1'b1 == ap_CS_iter1_fsm_state2) & (1'b1 == ap_block_state2_pp0_stage0_iter1))) & (ap_predicate_op26_read_state1 == 1'b1) & (1'b1 == ap_CS_iter0_fsm_state1)) | (~((ap_done_reg == 1'b1) | (1'b1 == ap_block_state1_pp0_stage0_iter0) | ((1'b1 == ap_CS_iter1_fsm_state2) & (1'b1 == ap_block_state2_pp0_stage0_iter1))) & (ap_predicate_op7_read_state1 == 1'b1) & (1'b1 == ap_CS_iter0_fsm_state1)))) begin
...
always @ (*) begin
    if ((((ure_state_load_reg_556 == 2'd2) & (1'b1 == ap_CS_iter1_fsm_state2)) | ((ap_predicate_op70_write_state2 == 1'b1) & (1'b1 == ap_CS_iter1_fsm_state2)) | ((1'b1 == ap_CS_iter1_fsm_state2) & (ap_predicate_op85_write_state2 == 1'b1)))) begin
...
always @ (*) begin
    if (((~((ap_done_reg == 1'b1) | (1'b1 == ap_block_state2_pp0_stage0_iter1)) & (ure_state_load_reg_556 == 2'd2) & (1'b1 == ap_CS_iter1_fsm_state2)) | (~((ap_done_reg == 1'b1) | (1'b1 == ap_block_state2_pp0_stage0_iter1)) & (ap_predicate_op70_write_state2 == 1'b1) & (1'b1 == ap_CS_iter1_fsm_state2)) | (~((ap_done_reg == 1'b1) | (1'b1 == ap_block_state2_pp0_stage0_iter1)) & (1'b1 == ap_CS_iter1_fsm_state2) & (ap_predicate_op85_write_state2 == 1'b1)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_iter1_fsm_state2) & (ap_predicate_op82_write_state2 == 1'b1))) begin
...
always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | (1'b1 == ap_block_state2_pp0_stage0_iter1)) & (1'b1 == ap_CS_iter1_fsm_state2) & (ap_predicate_op82_write_state2 == 1'b1))) begin
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | (real_start == 1'b0) | ((ap_predicate_op26_read_state1 == 1'b1) & (rxUdpDataIn_TVALID_int_regslice == 1'b0)) | ((rxUdpDataIn_TVALID_int_regslice == 1'b0) & (ap_predicate_op7_read_state1 == 1'b1)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (((ureMetaData_full_n == 1'b0) & (ap_predicate_op82_write_state2 == 1'b1)) | ((ure_state_load_reg_556 == 2'd2) & (ureDataPayload_full_n == 1'b0)) | ((ap_predicate_op70_write_state2 == 1'b1) & (ureDataPayload_full_n == 1'b0)) | ((ureDataPayload_full_n == 1'b0) & (ap_predicate_op85_write_state2 == 1'b1)));
end

always @ (*) begin
    ap_condition_123 = (~((ap_done_reg == 1'b1) | (1'b1 == ap_block_state1_pp0_stage0_iter0) | ((1'b1 == ap_CS_iter1_fsm_state2) & (1'b1 == ap_block_state2_pp0_stage0_iter1))) & (1'b1 == ap_CS_iter0_fsm_state1));
end

always @ (*) begin
    ap_condition_240 = ((grp_nbreadreq_fu_142_p6 == 1'd1) & (ure_state == 2'd1) & (tmp_fu_250_p3 == 1'd1) & (grp_fu_206_p1 == 1'd1));
end

always @ (*) begin
    ap_condition_244 = (~((ap_done_reg == 1'b1) | (1'b1 == ap_block_state2_pp0_stage0_iter1)) & (1'b1 == ap_CS_iter1_fsm_state2));
end

always @ (*) begin
    ap_condition_246 = ((grp_nbreadreq_fu_142_p6 == 1'd1) & (ure_state == 2'd1) & (tmp_fu_250_p3 == 1'd0) & (grp_fu_206_p1 == 1'd1));
end

always @ (*) begin
    ap_condition_255 = (~(ure_state == 2'd2) & ~(ure_state == 2'd1) & (grp_nbreadreq_fu_142_p6 == 1'd1) & (grp_fu_206_p1 == 1'd0));
end

always @ (*) begin
    ap_condition_99 = (~(ure_state_load_reg_556 == 2'd2) & ~(ure_state_load_reg_556 == 2'd1) & (tmp_i_reg_580 == 1'd1));
end
...
assign tmp_13_i_fu_454_p6 = {{{{{ap_phi_reg_pp0_iter1_sendWord_last_reg_182}, {trunc_ln154_reg_572}}, {trunc_ln152_fu_414_p1}}, {trunc_ln153_reg_567}}, {trunc_ln151_fu_410_p1}};

assign tmp_57_i2_fu_418_p5 = {{prevWord_data_1[511:288]}, {reg_230}};

assign tmp_59_i4_fu_436_p5 = {{prevWord_keep_1[63:36]}, {reg_234}};
...
assign zext_ln169_fu_466_p1 = tmp_13_i_fu_454_p6;
