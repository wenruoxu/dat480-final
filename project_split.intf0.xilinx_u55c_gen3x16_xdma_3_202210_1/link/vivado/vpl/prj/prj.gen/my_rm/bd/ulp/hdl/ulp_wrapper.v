...
module ulp_wrapper
  ...
  wire io_clk_qsfp1_refclka_00_clk_n;
  wire io_clk_qsfp1_refclka_00_clk_p;
  wire [3:0]io_gt_qsfp0_00_grx_n;
  wire [3:0]io_gt_qsfp0_00_grx_p;
  wire [3:0]io_gt_qsfp0_00_gtx_n;
  wire [3:0]io_gt_qsfp0_00_gtx_p;
  wire [3:0]io_gt_qsfp1_00_grx_n;
  wire [3:0]io_gt_qsfp1_00_grx_p;
  wire [3:0]io_gt_qsfp1_00_gtx_n;
  wire [3:0]io_gt_qsfp1_00_gtx_p;
  ...
  ulp ulp_i
       (.BLP_M_AXI_DATA_C2H_00_araddr(BLP_M_AXI_DATA_C2H_00_araddr),
        ...
        .io_clk_qsfp0_refclka_00_clk_n(io_clk_qsfp0_refclka_00_clk_n),
        .io_clk_qsfp0_refclka_00_clk_p(io_clk_qsfp0_refclka_00_clk_p),
        .io_clk_qsfp1_refclka_00_clk_n(io_clk_qsfp1_refclka_00_clk_n),
        .io_clk_qsfp1_refclka_00_clk_p(io_clk_qsfp1_refclka_00_clk_p),
        .io_gt_qsfp0_00_grx_n(io_gt_qsfp0_00_grx_n),
        .io_gt_qsfp0_00_grx_p(io_gt_qsfp0_00_grx_p),
        .io_gt_qsfp0_00_gtx_n(io_gt_qsfp0_00_gtx_n),
        .io_gt_qsfp0_00_gtx_p(io_gt_qsfp0_00_gtx_p),
        .io_gt_qsfp1_00_grx_n(io_gt_qsfp1_00_grx_n),
        .io_gt_qsfp1_00_grx_p(io_gt_qsfp1_00_grx_p),
        .io_gt_qsfp1_00_gtx_n(io_gt_qsfp1_00_gtx_n),
        .io_gt_qsfp1_00_gtx_p(io_gt_qsfp1_00_gtx_p));
endmodule
