...
#      puts "INFO: Read INIT=${sub_cell_init} on cell ${uuid_rom_sub_cell}"
  ...
  proc create_dr_heir {config_info} {
    ...
    clear_initial_pfm_attributes "cells" "AXI_PORT"
    clear_initial_pfm_attributes "cells" "AXIS_PORT"
    clear_initial_pfm_attributes "cells" "IRQ"
    clear_initial_pfm_attributes "cells" "CLOCK"
    clear_initial_pfm_attributes "ports" "CLOCK"
