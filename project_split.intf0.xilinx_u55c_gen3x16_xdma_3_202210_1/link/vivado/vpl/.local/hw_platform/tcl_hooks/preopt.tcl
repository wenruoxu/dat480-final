...
create_generated_clock -name hbm_aclk [get_pins level0_i/ulp/ulp_ucs/inst/aclk_hbm_hierarchy/clkwiz_hbm/inst/CLK_CORE_DRP_I/clk_inst/mmcme4_adv_inst/CLKOUT0]
...
# add_cells_to_pblock [get_pblocks pblock_dynamic_SLR2] [get_cells level0_i/ulp/memory_subsystem/inst/memory/plram_mem04] -quiet
# add_cells_to_pblock [get_pblocks pblock_dynamic_SLR2] [get_cells level0_i/ulp/memory_subsystem/inst/memory/plram_mem05] -quiet
# add_cells_to_pblock [get_pblocks pblock_dynamic_SLR2] [get_cells level0_i/ulp/memory_subsystem/inst/memory/plram_mem04_bram] -quiet
# add_cells_to_pblock [get_pblocks pblock_dynamic_SLR2] [get_cells level0_i/ulp/memory_subsystem/inst/memory/plram_mem05_bram] -quiet
# 
# 
