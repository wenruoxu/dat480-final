...
set_property value 16 ${MODELPARAM_VALUE.AXIL_CTRL_ADDR_WIDTH}
}
...
proc update_MODELPARAM_VALUE.STREAMING_TDEST_WIDTH { MODELPARAM_VALUE.STREAMING_TDEST_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	# WARNING: There is no corresponding user parameter named "STREAMING_TDEST_WIDTH". Setting updated value from the model parameter.
set_property value 16 ${MODELPARAM_VALUE.STREAMING_TDEST_WIDTH}
}

proc update_MODELPARAM_VALUE.STREAMING_TUSER_WIDTH { MODELPARAM_VALUE.STREAMING_TUSER_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	# WARNING: There is no corresponding user parameter named "STREAMING_TUSER_WIDTH". Setting updated value from the model parameter.
set_property value 96 ${MODELPARAM_VALUE.STREAMING_TUSER_WIDTH}
}
