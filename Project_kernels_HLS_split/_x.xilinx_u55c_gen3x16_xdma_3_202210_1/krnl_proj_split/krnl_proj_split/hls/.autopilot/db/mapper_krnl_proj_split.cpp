...
extern "C" void krnl_proj_split(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
extern "C" void apatb_krnl_proj_split_hw(volatile void * __xlx_apatb_param_input_stream_V_data_V, volatile void * __xlx_apatb_param_input_stream_V_keep_V, volatile void * __xlx_apatb_param_input_stream_V_strb_V, volatile void * __xlx_apatb_param_input_stream_V_user_V, volatile void * __xlx_apatb_param_input_stream_V_last_V, volatile void * __xlx_apatb_param_input_stream_V_id_V, volatile void * __xlx_apatb_param_input_stream_V_dest_V, volatile void * __xlx_apatb_param_output_stream_V_data_V, volatile void * __xlx_apatb_param_output_stream_V_keep_V, volatile void * __xlx_apatb_param_output_stream_V_strb_V, volatile void * __xlx_apatb_param_output_stream_V_user_V, volatile void * __xlx_apatb_param_output_stream_V_last_V, volatile void * __xlx_apatb_param_output_stream_V_id_V, volatile void * __xlx_apatb_param_output_stream_V_dest_V, volatile void * __xlx_apatb_param_processed_bytes, volatile void * __xlx_apatb_param_processed_cycles) {
using hls::sim::createStream;
auto* sinput_stream_V_data_V = createStream((hls::stream<__cosim_s64__>*)__xlx_apatb_param_input_stream_V_data_V);
auto* sinput_stream_V_keep_V = createStream((hls::stream<long long>*)__xlx_apatb_param_input_stream_V_keep_V);
auto* sinput_stream_V_strb_V = createStream((hls::stream<long long>*)__xlx_apatb_param_input_stream_V_strb_V);
...
auto* sinput_stream_V_dest_V = createStream((hls::stream<short>*)__xlx_apatb_param_input_stream_V_dest_V);
  ...
  __cosim_s64__* __xlx_output_stream_V_data_V_input_buffer= new __cosim_s64__[ap_apatb_output_stream_V_data_V_cap_bc];
auto* soutput_stream_V_data_V = createStream((hls::stream<__cosim_s64__>*)__xlx_apatb_param_output_stream_V_data_V);
  ...
  long long* __xlx_output_stream_V_keep_V_input_buffer= new long long[ap_apatb_output_stream_V_keep_V_cap_bc];
auto* soutput_stream_V_keep_V = createStream((hls::stream<long long>*)__xlx_apatb_param_output_stream_V_keep_V);
  ...
  long long* __xlx_output_stream_V_strb_V_input_buffer= new long long[ap_apatb_output_stream_V_strb_V_cap_bc];
auto* soutput_stream_V_strb_V = createStream((hls::stream<long long>*)__xlx_apatb_param_output_stream_V_strb_V);
...
auto* soutput_stream_V_id_V = createStream((hls::stream<char>*)__xlx_apatb_param_output_stream_V_id_V);
  ...
  short* __xlx_output_stream_V_dest_V_input_buffer= new short[ap_apatb_output_stream_V_dest_V_cap_bc];
auto* soutput_stream_V_dest_V = createStream((hls::stream<short>*)__xlx_apatb_param_output_stream_V_dest_V);
  // DUT call
  krnl_proj_split(sinput_stream_V_data_V->data<__cosim_s64__>(), sinput_stream_V_keep_V->data<long long>(), sinput_stream_V_strb_V->data<long long>(), sinput_stream_V_user_V->data<char>(), sinput_stream_V_last_V->data<char>(), sinput_stream_V_id_V->data<char>(), sinput_stream_V_dest_V->data<short>(), soutput_stream_V_data_V->data<__cosim_s64__>(), soutput_stream_V_keep_V->data<long long>(), soutput_stream_V_strb_V->data<long long>(), soutput_stream_V_user_V->data<char>(), soutput_stream_V_last_V->data<char>(), soutput_stream_V_id_V->data<char>(), soutput_stream_V_dest_V->data<short>(), __xlx_apatb_param_processed_bytes, __xlx_apatb_param_processed_cycles);
sinput_stream_V_data_V->transfer((hls::stream<__cosim_s64__>*)__xlx_apatb_param_input_stream_V_data_V);
sinput_stream_V_keep_V->transfer((hls::stream<long long>*)__xlx_apatb_param_input_stream_V_keep_V);
sinput_stream_V_strb_V->transfer((hls::stream<long long>*)__xlx_apatb_param_input_stream_V_strb_V);
...
sinput_stream_V_dest_V->transfer((hls::stream<short>*)__xlx_apatb_param_input_stream_V_dest_V);
soutput_stream_V_data_V->transfer((hls::stream<__cosim_s64__>*)__xlx_apatb_param_output_stream_V_data_V);
soutput_stream_V_keep_V->transfer((hls::stream<long long>*)__xlx_apatb_param_output_stream_V_keep_V);
soutput_stream_V_strb_V->transfer((hls::stream<long long>*)__xlx_apatb_param_output_stream_V_strb_V);
...
soutput_stream_V_dest_V->transfer((hls::stream<short>*)__xlx_apatb_param_output_stream_V_dest_V);
}
