...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { output_stream_TDATA { O 512 vector } output_stream_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { output_stream_TVALID { O 1 bit } output_stream_TDEST { O 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_short_matches \
    op interface \
    ports { short_matches_dout { I 33 vector } short_matches_num_data_valid { I 7 vector } short_matches_fifo_cap { I 7 vector } short_matches_empty_n { I 1 bit } short_matches_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_long_matches \
    op interface \
    ports { long_matches_dout { I 33 vector } long_matches_num_data_valid { I 7 vector } long_matches_fifo_cap { I 7 vector } long_matches_empty_n { I 1 bit } long_matches_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_out_data_6_out \
    op interface \
    ports { out_data_6_out { O 512 vector } out_data_6_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_out_keep_6_out \
    op interface \
    ports { out_keep_6_out { O 64 vector } out_keep_6_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_out_count_out \
    op interface \
    ports { out_count_out { O 32 vector } out_count_out_ap_vld { O 1 bit } } \
} "
}
